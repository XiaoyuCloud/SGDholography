...
r_ori = cv2.flip(cv2.imread('./recon/ExpColor/r.jpg'),1)
g_ori = cv2.flip(cv2.imread('./recon/ExpColor/g.jpg'),1)
b_ori = cv2.flip(cv2.imread('./recon/ExpColor/b.jpg'),1)
# r_ori=r_img[275:2300,140:3396,:]
# g_ori=g_img[275:2300,140:3396,:]
# b_ori=b_img[275:2300,140:3396,:]
# r_com=r_ori
